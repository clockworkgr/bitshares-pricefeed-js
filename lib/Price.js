...
class Price {
    ...
    toJSON() {
        return { base: { amount: this.base.amount, asset_id: this.base.asset_id}, quote: { amount: this.quote.amount, asset_id: this.quote.asset_id}};
    }
    invert() {
        var tmp =this.quote;
    ...
    Multiply(other) {
        ...
        if (other instanceof Price) {
            ...
            a.base.amount=a.base.amount*other*Math.pow(10,precision(other));
